...
export default class Chatroom extends React.Component {
  ...
  submitMessage = (e) => {
    ...
    receiveMessage(friendUsername, myUsername, input.value, "text");

    sendMessage(friendUsername, JSON.stringify({ content: input.value, contentType: "text" }));
  ...
  submitImage = (src) => {
    ...
    receiveMessage(friendUsername, myUsername, src, "image");

    sendMessage(friendUsername, JSON.stringify({ content: src, contentType: "image" }));
  }
